...
<nav class="share-links" aria-labelledby="share-links-heading">
    ...
    <ul class="share-links-list">
        <li class="share-links-item">
            <a
                class="share-links-link share-links-linkedin"
                href="https://www.linkedin.com/sharing/share-offsite/?url={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="{{ __('Share on LinkedIn') }} ({{ __('opens in a new tab') }})"
            >
        ...
        <li class="share-links-item">
            <a
                class="share-links-link share-links-bluesky"
                href="https://bsky.app/intent/compose?text={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="{{ __('Share on Bluesky') }} ({{ __('opens in a new tab') }})"
            >
        ...
        <li class="share-links-item">
            <a
                class="share-links-link share-links-x"
                href="https://x.com/intent/tweet?text={{ rawurlencode($model->title) }}&url={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="{{ __('Share on X') }} ({{ __('opens in a new tab') }})"
            >
        ...
        <li class="share-links-item">
            <a
                class="share-links-link share-links-facebook"
                href="https://www.facebook.com/sharer/sharer.php?u={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="{{ __('Share on Facebook') }} ({{ __('opens in a new tab') }})"
            >
        ...
        <li class="share-links-item">
            <a
                class="share-links-link share-links-whatsapp"
                href="https://wa.me/?text={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="{{ __('Share via WhatsApp') }} ({{ __('opens in a new tab') }})"
            >
